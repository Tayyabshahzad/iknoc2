                  ...
                  <table class="table">
                      ...
                      <tr>
                        ...
                        <td>
                            ...
                            <button class="btn btn-primary btn-sm  common_connection"data-toggle="modal" data-target="#exampleModal"  data-auth_id="{{ Auth::user()->id }}" data-common_id="{{ $idCommon }}"> Common Connection (@php print_r(get_common_conntections(Auth::user()->id,$idCommon)) @endphp) </button>
                        </td>
                      </tr> 
                      @endforeach
                  </table>
